...
#
# Historically the class was named ``PatchApplier``.  Define this alias so
# imports from ``patch.apply`` continue to function even though the class
# was renamed to ``PatchApplicator``.

PatchApplier = PatchApplicator
